...
## Lighthouse Score
<img src="/src/resources/screenshots/lighthouse_score.png" width="70%" height="70%" />
...
- By default the mobile view will display 3 items per page, while on desktop will display 4 items per page.
